...
omnipath = pd.read_csv('../data/annotation/omnipath_webservice_interactions__recent.tsv', sep='\t', low_memory=False)
...
#Add interactions
currationAdd = pd.read_csv('../data/curation/PKN/add.tsv', sep='\t', low_memory=False)
...
#Remove interactions
currationRemove = pd.read_csv('../data/curation/PKN/remove.tsv', sep='\t', low_memory=False)
...
#Edit interactions
currationEdit = pd.read_csv('../data/curation/PKN/edit.tsv', sep='\t', low_memory=False)
...
#Store full network
omnipath.to_csv('../preprocessing/preprocessed_data/ligand_pknFull.tsv', sep='\t', index=False)
...
RL = pd.read_csv('../preprocessing/preprocessed_data/RL.tsv', sep='\t', low_memory=False)
...
uniprot = pd.read_csv('../data/annotation/uniprot-reviewed_yes+AND+organism__Homo+sapiens+(Human)+[9606]_.tab', sep='\t', low_memory=False)
...
omnipath.to_csv('../preprocessing/preprocessed_data/pknL1000_ligands.tsv', sep='\t', index=False)
