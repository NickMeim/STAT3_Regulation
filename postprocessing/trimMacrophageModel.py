...
coreSources = ['KEGG', 'InnateDB','SIGNOR'] #not usefull here


#Load and trim PKN
PKN = pd.read_csv('../preprocessing/preprocessed_data/FilteredOmnipath_kegg.tsv', sep='\t', low_memory=False, index_col=0)
PKNFull = PKN.copy()
...
PKN.to_csv('../preprocessing/preprocessed_data/KEGG-Model.tsv', sep='\t', index=False)
