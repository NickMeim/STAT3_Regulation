...
#Add interactions
currationAdd = pd.read_csv('../data/curation/RL/add.tsv', sep='\t', low_memory=False)
...
#Remove interactions
currationRemove = pd.read_csv('../data/curation/RL/remove.tsv', sep='\t', low_memory=False)
...
#Edit interactions
currationEdit = pd.read_csv('../data/curation/RL/edit.tsv', sep='\t', low_memory=False)
...
omnipath.to_csv('../preprocessing/preprocessed_data/RLFull.tsv', sep='\t', index=False)
...
omnipath.to_csv('../preprocessing/preprocessed_data/RL.tsv', sep='\t', index=False)
